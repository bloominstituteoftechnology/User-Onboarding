...
- explain what end-to-end testing is and its importance
      A - End to End testing is the "full run through" of an app. From loading the page and components, making a profile, posting the information to the server and signing out. It's to test the complete functionality of the website and that it achieves the desired goals of the client through the designer's implimentation of their requirements - you want to satisfy the question of your confidence before you ship your code to the client. 
...
* [ It says to submit the same as yesterday so I did :) ] Submit a Pull-Request to merge `<firstName-lastName>` Branch into `main` (student's  Repo). **Please don't merge your own pull request**
